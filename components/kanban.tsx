...
export const kanbanBoardColumnClassNames =
  'w-80 flex-shrink-0 rounded-lg border flex flex-col border-border bg-sidebar py-2 max-h-full';
...
export type KanbanBoardCardProps<T extends { id: number } = { id: number }> = {
  /**
